...
const bubble5Style = `${styles.insctructorBubble} ${styles.bubble5}`
    return <div className={styles.container}>
        ...
        <div className={styles.contentBox}>
            ...
            <p>Nasz zespół to grono doświadczonych instruktorów, którzy od lat z pasją i zaangażowaniem szkolą w zakresie pływania. Każdy z naszych instruktorów to osoba, która osobiście trenowała pływanie i posiada bogate doświadczenie w tej dziedzinie. Dzięki temu możemy zapewnić profesjonalne i rzetelne podejście do każdego uczestnika – wiemy, jak wygląda trening z perspektywy pływaka, i potrafimy skutecznie przekazywać wiedzę oraz technikę.</p>
       <LinkButton bgColor='white' textColor='basicOrange' title='Dowiedz się więcej' href='/naszzespol'/>
        </div>
