...
bezpieczeństwo i indywidualne postępy. Zapisz się już dziś i odkryj radość z pływania!"
        ...
        <div className={styles.categoriesBoxRow}>
          <div className={styles.cardBox}>
            <h4>NIEMOWLAKI</h4>
            <p>Maluchy oswajają się z wodą poprzez zabawy z opiekunami. Ćwiczą
            podstawowe ruchy, które wspierają rozwój motoryczny i wzmacniają więź z rodzicem.</p>
          </div>
          <div className={styles.cardBox}>
            <h4>DZIECI I MŁODZIEŻ</h4>
            <p>Dzieci uczą się podstaw pływania w formie zabawy. Poprawiają technikę i
...
wytrzymałość i przygotowują do ewentualnych startów w zawodach pływackich.</p>
          </div>
          <div className={styles.cardBox}>
            <h4>DOROŚLI</h4>
            <p>Mogą zarówno doskonalić swoje umiejętności, jak i rozpocząć naukę
...
prawidłowej techniki pod okiem doświadczonych instruktorów.</p>
          </div>
