    ...
    <div className={styles.campLayout} style={{marginTop: '-6rem'}}>
      ...
      <div className={styles.content}>
        ...
        <div className={styles.cardBoxWinter}>
            <h4>PÓŁKOLONIE</h4>
            <p>Udowadniamy, że zima to doskonały czas na aktywność! Dzieci
...
zimowej scenerii!</p>
          ...
          <div className={styles.cardBoxWinter}>
            <h4>OBOZY</h4>
            <p>Uczestnicy będą mieli okazję nauczyć się lub doskonalić
...
niezapomniane wrażenia i mnóstwo frajdy.</p>
          </div>
