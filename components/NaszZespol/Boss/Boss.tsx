...
<div className={styles.contentBox}>
  ...
  <p> Stworzyłam Nemo Sportową Przygodę, aby rozbudzić w ludziach pasję do
          ...
          energii.</p>
          <p> Nic nie daje mi większej satysfakcji niż widok uśmiechniętych dzieci,
          ...
          talenty, rozwijać pewność siebie i czerpać radość z ruchu.</p>
          <p>Nemo Sportowa Przygoda to nie tylko nauka pływania, to
          przestrzeń, w której każde dziecko i dorosły może doświadczyć, jak
          cudownie jest być aktywnym.</p>
          <p><b> Zapraszamy do wspólnej przygody, która może zmienić nawyki na całe
          życie!</b></p>
  
</div>
<img src={BossImage1.src} className={styles.imageRight}/></div>
