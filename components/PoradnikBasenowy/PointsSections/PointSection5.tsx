  ...
  return (
    <div className={styles.pointSection} id="5">
      ...
      <div className={styles.rowBox}>
        <img src={NemoSwimmerLogo.src} alt='nemoLogo' className={styles.image}/>
       

        <div className={styles.text}>
          <div className={styles.poolNecessaryItemsrowBox}>
            <div className={styles.poolNecessaryItemsitem}>
              <img src={SwimCapIcon.src} alt='swimCap' className={styles.poolNecessaryItemsimage}/>
             
              <span
                className={styles.poolNecessaryItemstitle}
              >
                CZEPEK I OKULARY
              </span>
            </div>
            ...
            <div className={styles.poolNecessaryItemsitem}>
            <img src={SwimSuitIcon.src} alt='swimSuit' className={styles.poolNecessaryItemsimage}/>
            ...
            <div className={styles.poolNecessaryItemsitem}>
            <img src={FlipFlopsIcon.src} alt='flipFlops' className={styles.poolNecessaryItemsimage}/>
            ...
            <div className={styles.poolNecessaryItemsitem}>
            <img src={TowelIcon.src} alt='towel' className={styles.poolNecessaryItemsimage}/>
