      ...
      <div className={styles.rowBox}>
        ...
        <div className={styles.text}>
          <span className={styles.textBox}>
            <span className={styles.title}>ZGŁASZANIE NIEOBECNOŚCI</span>
          ...
          <span className={styles.textBox}>
            <span className={styles.title}>FORMA ODRABIANIA ZAJĘĆ</span>
          ...
          <span className={styles.textBox}>
            <span className={styles.title}>REZERWACJA TERMINU ODRABIANIA</span>
          ...
          <span className={styles.textBox}>
            <span className={styles.title}>ODRABIANIE KURSY GRUPOWE</span>
          ...
          <span className={styles.textBox}>
            <span className={styles.title}>ODRABIANIE KURSY INDYWIDUALNE</span>W
            przypadku kursów indywidualnych i dwuosobowych opóźnione zgłoszenie
            nieobecności utrudnia organizację zajęć i uniemożliwia zapełnienie
            luki w grafiku. W efekcie Organizator ponosi straty finansowe, traci
            czas oraz napotyka trudności w bieżącym zarządzaniu zajęciami.
          </span>
        </div>
      </div>
    </div>
