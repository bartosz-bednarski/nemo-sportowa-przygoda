      ...
      <img src={LogoMainWhiteImg.src} alt='logoNemo' className={styles.logo}/>
        ...
        <ul className={styles.socjal}>
          <li>
            ...
            <img src={FacebookImg.src} alt='facebookImg' className={styles.image}/>
          ...
          <li>
            ...
            <img src={InstagramImg.src} alt='instagramImg' className={styles.image}/> nemo_sportowa_przygoda_
            </Link>
          </li>
          <li>
