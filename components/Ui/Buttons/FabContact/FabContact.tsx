  ...
  return (
    <>
      <div className={styles.buttonPcContainer}>
        ...
        <div className={styles.buttonPcBox}>
          <img className={styles.locationIcon} alt='Zapisy baseny Małopolska' width={36} height={36} loading='eager' fetchPriority='high' src={LocationIcon.src} />
          <div className={styles.textBox}>
            <p>Zapisy Baseny Małopolska</p>
            <p>+48 519 625 894</p>
          </div>
          <span className={styles.phoneBox}>
            <img alt='Skontakuj się zapisy Małopolska' width={32} height={32} loading='eager' fetchPriority='high' src={PhoneIcon.src} />
          </span>
        </div>
        <button
        ...
        >
          <img alt='Kontakt zapisy baseny' width={36} height={36} loading='eager' fetchPriority='high' src={!showContact ? PhoneIcon.src : CrossIcon.src} />
        </button>
        <button
          onClick={toggleContactHandler}
        ...
        >
          <img alt='Kontakt zapisy baseny' width={24} height={24} loading='eager' fetchPriority='high' src={!showContact ? PhoneIcon.src : CrossIcon.src} />
        </button>
        <div
        ...
        >
          <a href="tel:+48 789 246 614" className={styles.rowBox}>
            <img alt='Skontakuj się zapisy Kraków' width={32} height={32} loading='eager' fetchPriority='high' className={styles.phoneIcon} src={PhoneIcon.src} />
          ...
          <a href="tel:+48 519 625 894" className={styles.rowBox}>
            <img alt='Skontakuj się zapisy Małopolska' width={32} height={32} loading='eager' fetchPriority='high' className={styles.phoneIcon} src={PhoneIcon.src} />
            <div className={styles.columnBox}>
              <p>Zapisy Baseny Małopolska</p>
              <p>+48 519 625 894</p>
            </div>
