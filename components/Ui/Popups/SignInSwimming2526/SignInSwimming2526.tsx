    ...
    return <div  className={styles.popup} style={{display: showPopup ? 'flex' : 'none'}}>
      <div className={styles.contentBox}>
        ...
        <div className={styles.headerBox}>
          <span className={styles.header}>Ruszamy z zapisami nauki pływania!</span>
          <span className={`${styles.header} ${styles.accent}`}>Kurs Jesienno-Zimowy 2025/2026</span>
        </div>
