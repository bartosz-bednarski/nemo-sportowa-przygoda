...
import {WEEKEND_NA_STOKU_22_12_2024} from '@/utils/Winter/WeekendoweNarty';
...
export const metadata: Metadata = {
  ...
  description:
    'Zimowa przygoda w Tyliczu - nauka jazdy na nartach i snowboardzie! - 22.12.2024. Zimowe ferie małopolskie z NEMO!',
  metadataBase: new URL(
    'https://nemosportowaprzygoda.pl/ofertazimowa/weekend-na-stoku/termin-1'
  ),
  alternates: {
    canonical:
      'https://nemosportowaprzygoda.pl/ofertazimowa/weekend-na-stoku/termin-1',
...
const WeekendNaStoku = () => {
  return (
    <main className={styles.main} style={{background: 'white'}}>
      <Hero hero={WEEKEND_NA_STOKU_22_12_2024.hero} />
      <Details details={WEEKEND_NA_STOKU_22_12_2024.details} />

      <Contact contact={WEEKEND_NA_STOKU_22_12_2024.contactNemo} />

      <MountainsTrees />
      <Schedule schedule={WEEKEND_NA_STOKU_22_12_2024.schedule} />
      <WhatsWaiting4You
        details={WEEKEND_NA_STOKU_22_12_2024.whatsWaiting4You}
      />

      <MountainsTrees />
      <HillSides hillSides={WEEKEND_NA_STOKU_22_12_2024.hillSides} />
      <PriceDetails priceDetails={WEEKEND_NA_STOKU_22_12_2024.priceDetails} />
