...
import {WEEKEND_NA_STOKU_12_01_2025} from '@/utils/Winter/WeekendoweNarty';
...
export const metadata: Metadata = {
  ...
  description:
    'Zimowa przygoda w Tyliczu - nauka jazdy na nartach i snowboardzie! - 12.01.2025. Zimowe ferie małopolskie z NEMO!',
  metadataBase: new URL(
    'https://nemosportowaprzygoda.pl/ofertazimowa/weekend-na-stoku/termin-2'
  ),
  alternates: {
    canonical:
      'https://nemosportowaprzygoda.pl/ofertazimowa/weekend-na-stoku/termin-2',
...
const WeekendNaStoku = () => {
  return (
    <main className={styles.main} style={{background: 'white'}}>
      <Hero hero={WEEKEND_NA_STOKU_12_01_2025.hero} />
      <Details details={WEEKEND_NA_STOKU_12_01_2025.details} />

      <Contact contact={WEEKEND_NA_STOKU_12_01_2025.contactNemo} />

      <MountainsTrees />
      <Schedule schedule={WEEKEND_NA_STOKU_12_01_2025.schedule} />
      <WhatsWaiting4You
        details={WEEKEND_NA_STOKU_12_01_2025.whatsWaiting4You}
      />

      <MountainsTrees />
      <HillSides hillSides={WEEKEND_NA_STOKU_12_01_2025.hillSides} />
      <PriceDetails priceDetails={WEEKEND_NA_STOKU_12_01_2025.priceDetails} />
